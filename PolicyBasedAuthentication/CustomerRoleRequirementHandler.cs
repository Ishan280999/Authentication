...
namespace PolicyBasedAuthentication
{
    ...
    {
        public CustomerRequirement(string apiKey, string secretKey)
        {
            SecretKey = secretKey;
            ApiKey = apiKey;
        }
    ...
    public class CustomerRoleRequirementHandler : AuthorizationHandler<CustomerRequirement>
    {
        ...
        private Task CheckApiKey(AuthorizationHandlerContext context, CustomerRequirement requirement)
        {
