...
namespace PolicyBasedAuthentication
{
    ...
    {
        public AdminRequirement(string apiKey, string secretKey)
        {
            SecretKey = secretKey;
            ApiKey = apiKey;
        }
    ...
    public class AdminRoleRequirementHandler : AuthorizationHandler<AdminRequirement>
    {
        ...
        private Task CheckApiKey(AuthorizationHandlerContext context, AdminRequirement requirement)
        {
